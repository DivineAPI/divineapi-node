...
exports.resolveHouseSystem = resolveHouseSystem;
exports.applyHouseSystem = applyHouseSystem;
exports.applyBirthSecondDefaults = applyBirthSecondDefaults;
...
const HOUSE_SYSTEM_FRIENDLY_NAMES = 'placidus, koch, porphyry, regiomontanus, campanus, equal, equal-asc, equal-mc, ' +
...
function resolveHouseSystem(value) {
    ...
    throw new errors_js_1.ValidationError(`Invalid house_system '${value}'. Must be one of: ${HOUSE_SYSTEM_FRIENDLY_NAMES} ` +
 ...
 */
function applyHouseSystem(params) {
 ...
 */
function applyBirthSecondDefaults(params) {
    let out = params;
