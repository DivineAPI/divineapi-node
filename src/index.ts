...
export class DivineApi {
  ...
  public readonly horoscope: HoroscopeApi;
  /** Indian Astrology (Panchang, Kundli, Match Making, Festivals) */
  public readonly indian: IndianApi;
  /** Western Astrology (Natal, Synastry, Transit, Composite, Returns, Progressions, Prenatal) */
  public readonly western: WesternApi;
  /** PDF Report generation endpoints */
  public readonly pdf: PdfReportApi;
  /** Numerology endpoints */
  public readonly numerology: NumerologyApi;
  /** Lifestyle endpoints */
  public readonly lifestyle: LifestyleApi;
  /** Calculator endpoints */
  public readonly calculators: CalculatorApi;
