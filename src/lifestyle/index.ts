...
export class LifestyleApi {
  ...
  async zodiacGiftGuru(params: LifestyleParams): Promise<ApiResponse> {
    return this.client.post('astroapi-7.divineapi.com', '/api/v1/zodiac-gift-guru', params as unknown as Record<string, unknown>);
  }

  /** Get beauty by the stars recommendations. */
  async beautyByStars(params: LifestyleParams): Promise<ApiResponse> {
    return this.client.post('astroapi-7.divineapi.com', '/api/v1/beauty-by-the-stars', params as unknown as Record<string, unknown>);
  }

  /** Get astro chic picks. */
  async astroChicPicks(params: LifestyleParams): Promise<ApiResponse> {
    return this.client.post('astroapi-7.divineapi.com', '/api/v1/astro-chic-picks', params as unknown as Record<string, unknown>);
  }
}
